...
\begin{center} \hrule \s {\textbf { \large ECE 420 --- Latex Homework Examples}} \end{center}

{\textbf{Name:}\ John Doe \hspace{\fill} \textbf{Due Date:} August 32, 2020, 9:00 AM \par
{\textbf{Mailbox Number:}} \ 420 \hspace{75 mm} \textbf{Assignment:} 3 \vspace{.4cm} \par \hrule \vspace{.4cm}
